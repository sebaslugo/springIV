...
def create_lenet_model(
    ...
    model.add(Conv2D(6, (3, 3), activation='tanh', input_shape=input_shape))
    ...
    model.add(Conv2D(16, (3, 3), activation='tanh', input_shape=input_shape))
    ...
    # followed by a tanh activation function
    model.add(Dense(120, activation='tanh', input_dim=input_shape))

    # Layer 7: Fully connected layer with 84 neurons,
    # followed by a tanh activation function
    model.add(Dense(84, activation='tanh', input_dim=input_shape))
